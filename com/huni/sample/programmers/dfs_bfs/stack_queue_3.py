...
# location은 0 이상 (현재 대기목록에 있는 작업 수 - 1)
# 이하의 값을 가지며 대기목록의 가장 앞에 있으면 0, 두 번째에 있으면 1로 표현합니다.
...
def solution(priorities, location):
    ...
    #         priorities_deque.appendleft(temp)
    #         stack.appendleft(temp_index)
    #         break
    #     else:
    ...
    # stack = [x for x in range(len(priorities))]
    # stack_deque = collections.deque(stack)
    # priorities_deque = collections.deque(priorities)
    # bigger = False
    #
    # while True:
    #     temp = priorities_deque.popleft()
    #     temp_index = stack_deque.popleft()
    #     bigger = False
    #     for i in list(priorities_deque):
    #         if temp > i:
    #             continue
    #         else:
    #             bigger = True
    ...
    #     if bigger:
    #         priorities_deque.append(temp)
    #         stack_deque.append(temp_index)
    #     else:
    #         priorities_deque.appendleft(temp)
    #         stack_deque.appendleft(temp_index)
    #         break
    #
